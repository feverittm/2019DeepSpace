...
public class OI {
  ...
  public double getLeftYAxis() {
    return condition_gamepad_axis(0.05, -driver.getRawAxis(RobotMap.Buttons.leftYAxis), -1, 1);
  }

  public double getRightXAxis() {
    return condition_gamepad_axis(0.05, driver.getRawAxis(RobotMap.Buttons.rightXAxis), -1, 1);
  }

  public double getRightYAxis() {
    return condition_gamepad_axis(0.05, -driver.getRawAxis(RobotMap.Buttons.rightYAxis), -1, 1);
  }
